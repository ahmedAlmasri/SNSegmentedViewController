//
//  SNSegmentedViewController.swift
...
@objc public protocol SNSegmentedViewControllerDelegate {
     ...
     */
    @objc optional func didMoveToPage(_ controller: UIViewController, segment: SNSegmentTab?, index: Int)
}

/**
 *  Public protocol of  SJSegmentedViewController for content changes and makes the scroll effect.
 */
@objc public protocol SNSegmentedViewControllerViewSource {
 ...
 */
@objc open class SNSegmentedViewController: UIViewController {
     ...
     */
    open var segmentShadow = SNShadow() {
        didSet {
     ...
     */
    open var segments: [SNSegmentTab] {
        get {
    ...
    open var showsVerticalScrollIndicator = true {
        didSet {
            segmentedScrollView.snShowsVerticalScrollIndicator = showsVerticalScrollIndicator
        }
    }
    ...
    open var showsHorizontalScrollIndicator = true {
        didSet {
            segmentedScrollView.snShowsHorizontalScrollIndicator = showsHorizontalScrollIndicator
        }
    }
    ...
    open var disableScrollOnContentView: Bool = false {
        didSet {
            segmentedScrollView.snDisableScrollOnContentView = disableScrollOnContentView
        }
    }
    
    open weak var delegate:SNSegmentedViewControllerDelegate?
    var segmentedScrollView = SNSegmentedScrollView(frame: CGRect.zero)
     ...
     */
    private func getTopSpacing(_ viewController: UIViewController) -> CGFloat {
     ...
     */
    private func getBottomSpacing(_ viewController: UIViewController) -> CGFloat {
    ...
    override open func viewDidLayoutSubviews() {
        ...
        let topSpacing = getTopSpacing(self)
        segmentedScrollView.topSpacing = topSpacing
        segmentedScrollView.bottomSpacing = getBottomSpacing(self)
    ...
    func addSegmentedScrollView() {
        ...
        let bottomSpacing = getBottomSpacing(self)
    ...
    func addContentControllers(_ contentControllers: [UIViewController]) {
        ...
        for controller in contentControllers {
            ...
            let delegate = controller as? SNSegmentedViewControllerViewSource
