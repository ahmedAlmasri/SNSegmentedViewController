...
class SNSegmentView: UIScrollView {
    ...
    required override init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(self.didChangeSegmentIndex(_:)),
    ...
    func getSegmentTabForController(_ controller: UIViewController) -> SNSegmentTab {
        
        var segmentTab: SNSegmentTab?
        
        if controller.navigationItem.titleView != nil {
            segmentTab = SNSegmentTab.init(view: controller.navigationItem.titleView!)
        } else {
