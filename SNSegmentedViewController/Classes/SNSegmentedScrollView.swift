...
import Foundation
import UIKit
class SNSegmentedScrollView: UIScrollView {
    
    var segmentView: SNSegmentView?
    ...
    var snShowsVerticalScrollIndicator: Bool = false {
        didSet {
            showsVerticalScrollIndicator = snShowsVerticalScrollIndicator
            contentView?.showsVerticalScrollIndicator = snShowsVerticalScrollIndicator
        }
    }
    
    var snShowsHorizontalScrollIndicator: Bool = false  {
        didSet {
            showsHorizontalScrollIndicator = snShowsHorizontalScrollIndicator
            contentView?.showsHorizontalScrollIndicator = snShowsHorizontalScrollIndicator
        }
    }
    
    private var viewObservers = [UIView]()
    var snDisableScrollOnContentView: Bool = false {
        didSet {
            contentView?.isScrollEnabled = !snDisableScrollOnContentView
        }
    }
    ...
    func addSegmentView(_ controllers: [UIViewController], frame: CGRect) {
        ...
        if controllers.count > 1 {
            ...
            segmentView = SNSegmentView(frame: CGRect.zero)
    ...
    func addSegmentsForContentViews(_ titles: [String]) {
        ...
        segmentView = SNSegmentView(frame: frame)
    ...
    func createContentView() -> SNContentView {
        
        let contentView = SNContentView(frame: CGRect.zero)
        contentView.showsVerticalScrollIndicator = snShowsVerticalScrollIndicator
        contentView.showsHorizontalScrollIndicator = snShowsHorizontalScrollIndicator
        contentView.isScrollEnabled = !snDisableScrollOnContentView
