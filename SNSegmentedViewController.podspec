#
# Be sure to run `pod lib lint SNSegmentedViewController.podspec' to ensure this is a
...
Segment in view controller with header view for ios
  ...
  s.source_files = 'SNSegmentedViewController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SNSegmentedViewController' => ['SNSegmentedViewController/Assets/*.png']
  # }
